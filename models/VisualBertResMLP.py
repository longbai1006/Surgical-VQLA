'''
Description     : VisualBERT ResMLP model that integrates VisualBERT model and ResMLP model.
...
Acknowledgement : Official implementation of VisualBERT ResMLP (https://github.com/lalithjets/Surgical_VQA).
                  It is modified from VisualBERT (huggingface/transformers (https://github.com/huggingface/transformers.git) and 
                  ResMLP (https://github.com/facebookresearch/deit).
'''
