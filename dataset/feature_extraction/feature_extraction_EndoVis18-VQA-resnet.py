...
for img_loc in tqdm(new_filenames):
    ...
    save_dir = '/' + os.path.join(img_loc[0],img_loc[1],img_loc[2],img_loc[3],img_loc[4],img_loc[5],img_loc[6],img_loc[7],'vqla/img_features',(str(args.patch_size)+'x'+str(args.patch_size)))
