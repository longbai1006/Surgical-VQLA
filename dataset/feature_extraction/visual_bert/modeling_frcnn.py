...
from visual_bert.utils import WEIGHTS_NAME, Config, cached_path, hf_bucket_url, is_remote_url, load_checkpoint
...
def norm_box(boxes, raw_sizes):
    ...
    # print('normalized_boxes[:, :, (0, 2)]', normalized_boxes[:, :, (0, 2)].shape)
    # print('raw_sizes[:, 1]', raw_sizes[:, 1].shape)
    # print('raw_sizes[:, 0]', raw_sizes[:, 0].shape)    
...
class ROIPooler(nn.Module):
    ...
    def forward(self, feature_maps, boxes):
        ...
        # print('len(x)',len(x))
        # print('num_level_assignments', num_level_assignments)
...
class GeneralizedRCNN(nn.Module):
    ...
    def inference(
        ...
        **kwargs,
        ...
        # print('image_shapes', image_shapes.device)
        # print('scales_yx', scales_yx.device)        
        original_sizes = image_shapes * scales_yx
        features = self.backbone(images)
        # print('images', images.shape) 
        # print('features', features['res4'].shape) # features torch.Size([64, 1024, 50, 76])
        ...
        # print('feature_pooled',feature_pooled.shape) #feature_pooled torch.Size([103, 2048])
        ...
        # print('roi_features0',roi_features[0].shape)
        roi_features = pad_list_tensors(roi_features, preds_per_image, **subset_kwargs)
        # print('roi_features1',roi_features.shape)
